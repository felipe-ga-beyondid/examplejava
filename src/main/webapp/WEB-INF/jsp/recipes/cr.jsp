...
<div class="prep col md-col-8 xs-mx2 xs-mb4 xs-mt2 md-mt0 xs-flex-order-3 md-flex-order-2">
  ...
  <div>
    <ol class="prep-steps list-unstyled xs-text-3">
            ...
            <li class="xs-mb2">In a large bowl, whisk together the warm milk, melted butter, and granulated sugar. The mixture should be just warm, registering between 100-110ËšF (40ËšC). If hotter, allow to cool slightly before proceeding. </li>
            ...
            <li class="xs-mb2">Preheat the oven to 325ËšF (160ËšC).</li>
