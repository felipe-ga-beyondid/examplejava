...
class AuthenticationLambdaServlet extends HttpServlet {
    ...
    AuthenticationLambdaServlet(final String path, AuthenticationServletHandler postConsumer) {
        this((request, response) -> AuthenticationActions.forward(path, request, response), postConsumer);
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            AuthenticationActions.forward("/WEB-INF/jsp/authn/login.jsp", req, resp);
        }
    }
